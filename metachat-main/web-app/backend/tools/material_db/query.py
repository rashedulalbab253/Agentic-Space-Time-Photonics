...
class MaterialQueryInterface:
    def __init__(self, 
                 ...
                 debug: bool = False,
                 log_dir: str = "logs/materials_chat"):
...
# 0. Think about the application, constraints, and the types of materials that might be suitable
# 1. Find materials in wavelength range
# 2. Check citation counts and publication years
# 3. Query detailed specs for promising candidates (never query entire tables, just count rows or find the first few entries)
